...
print("[1/2] Loading...")
--#region Libs
local LibraryHttps = "https://raw.githubusercontent.com/9XW/sslib/main/ss"
local LibraryESPHttps = "https://raw.githubusercontent.com/9XW/ssesp/main/ss"
...
local CrimWare = Library:CreateWindow(Name, Vector2.new(492, 600))
CoreGui:FindFirstChild(Name).main.top.title.Text = Name.."|"..GameName.."|"
local General = CrimWare:CreateTab("General")
local Combat = CrimWare:CreateTab("Combat")
local Misc = CrimWare:CreateTab("Misc")
local Visuals = CrimWare:CreateTab("Visuals")
local Teleports = CrimWare:CreateTab("Teleports")
local Settingss = CrimWare:CreateTab("Settings")
